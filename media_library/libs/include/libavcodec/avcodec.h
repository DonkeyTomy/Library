...
typedef struct AVCodecContext {
     ...
     * - decoding: Set by user, will be converted to uppercase by libavcodec during initParams.
     */
...
typedef struct AVCodec {
     ...
     * If the codec allocates writable tables in initParams(), re-allocate them here.
 ...
 * especially if the compensation_distance is large and the in_rate used during initParams is small
 */
attribute_deprecated
