...
public class MediaMuxerWrapper {
	...
	private static final String TAG = "MediaEncoderTMuxer";
...
//**********************************************************************
	...
	/*package*/ void addEncoder(final MediaEncoder encoder) {
        ...
        if (DEBUG) Log.v(TAG,  "mEncoderCount: " + mEncoderCount);
    }
	...
	/*package*/ synchronized boolean start() {
		mStatredCount++;
        if (DEBUG) Log.v(TAG,  "start: mStartCount" + mStatredCount + "; mEncoderCount " + mEncoderCount);
	...
	*/
	...
	/*package*/ synchronized void writeSampleData(final int trackIndex, final ByteBuffer byteBuf, final MediaCodec.BufferInfo bufferInfo) {
        if (DEBUG) Log.d(TAG, "writeSampleData " + mStatredCount);
